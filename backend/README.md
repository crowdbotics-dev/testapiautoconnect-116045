...
## Project Structure
    ...
    ├── testapiautoconnect_116045  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116045`
...
2. Clone this repo and `cd testapiautoconnect_116045`
